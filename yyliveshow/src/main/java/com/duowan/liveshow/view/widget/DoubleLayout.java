package com.duowan.liveshow.view.widget;
...
public class DoubleLayout extends RelativeLayout {
    ...
    public void reArrageLayout() {
        ...
        List<YVideoViewLayout> yList = new LinkedList<YVideoViewLayout>();
        for (int i = 0; i < childCount; i++) {
            if (getChildAt(i) instanceof YVideoViewLayout) {
                YVideoViewLayout child = (YVideoViewLayout) getChildAt(i);
    ...
    private void adjustSize(YVideoViewLayout childView, int sw, int sh, int idx, boolean single) {
